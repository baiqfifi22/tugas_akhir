...
export default function TeacherLanding() {
  const myClasses = [
    { id: "10-a", name: "Kelas 10-A", students: 32, label: "Wali Kelas" },
    { id: "10-b", name: "Kelas 10-B", students: 30, label: "Guru Mapel" },
    { id: "11-ipa", name: "Kelas 11 IPA", students: 28, label: "Guru Mapel" },
  ];
          ...
          <div className="flex justify-between">
            ...
            <div className="relative z-10 px-8 py-10 md:px-12 max-w-2xl ">
              <h1 className="text-3xl md:text-4xl font-bold mb-4 text-black">
                Selamat Datang, Bapak Budi Santoso!
              </h1>
