...
const MOCK_STATS = [
  ...
  { label: "Hadir Hari Ini", value: "320", icon: UserCheck, color: "text-emerald-600", bg: "bg-emerald-50" },
  { label: "Sakit/Izin", value: "15", icon: Clock, color: "text-yellow-600", bg: "bg-yellow-50" },
  { label: "Alpa", value: "7", icon: UserX, color: "text-red-600", bg: "bg-red-50" },
];

const MOCK_LOGS = [
  { id: 1, date: "13 Apr 2026", cls: "10A", teacher: "Budi Santoso", subject: "Matematika", present: 30, absent: 2, status: "Submitted" },
  { id: 2, date: "13 Apr 2026", cls: "10B", teacher: "Siti Rahma", subject: "Bahasa Inggris", present: 31, absent: 1, status: "Submitted" },
  { id: 3, date: "13 Apr 2026", cls: "11A", teacher: "Ahmad Dahlan", subject: "Fisika", present: 28, absent: 4, status: "Draft" },
  { id: 4, date: "13 Apr 2026", cls: "12C", teacher: "Dian Sastro", subject: "Biologi", present: 32, absent: 0, status: "Submitted" },
];
